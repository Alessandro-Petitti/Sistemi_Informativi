...
-- Table `mydb`.`Reparti`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Reparti` (
...
-- -----------------------------------------------------
-- Table `mydb`.`ProdottiInVendita`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`ProdottiInVendita` (
...
-- -----------------------------------------------------
-- Table `mydb`.`Recensioni`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Recensioni` (
  ...
  CONSTRAINT `fk_Recensiscono_ProdottiInVendita1`
    ...
    REFERENCES `mydb`.`ProdottiInVendita` (`idProdotto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `mydb`.`Acquisti`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Acquisti` (
  `Utenti_idUtenti` INT NOT NULL,
  `ProdottiInVendita_idProdotto` INT NOT NULL,
  `Quantità` INT NULL,
  `Data` DATE NULL,
