...
?>
          ...
          if(isset($_POST["Username"]) && $_SERVER['REQUEST_METHOD'] === 'POST'){
            ...
            if ($result->num_rows > 0) {
              $message_add="Sei già registrato, effettua il login";
            }
            else{
...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <header class="header-area clearfix">
            ...
            <!-- Amado Nav -->
            <nav class="amado-nav">
              <a href="indexpaginaprotetta.php" class="btn amado-btn mb-15">Bentornato!</a>
                <ul>
            ...
            <div class="cart-fav-search mb-100">
                ...
                <a href="#" class="search-nav"><img src="img/core-img/search.png" alt=""> Cerca</a>
            </div>
            <!-- Social Button -->
        </header>
        <!-- Header Area End -->
