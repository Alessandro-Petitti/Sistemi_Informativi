                        ...
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(img/product-img/Piantana_bianca.jpg);">
                                    </li>
                                </ol>
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="img/product-img/Piantana_bianca.jpg">
                                            <img class="d-block w-100" src="img/product-img/Piantana_bianca.jpg" alt="First slide">
                                        </a>
                                    </div>
                        ...
                        <div class="single_product_desc">
                            ...
                            <div class="product-meta-data">
                                ...
                                <div class="ratings-review mb-15 d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="review">
                                        <a href="sedia_bianca.html">Robustezza e qualità</a>
                                    </div>
                                </div>
                                <!-- Avaiable -->
                            ...
                            <nav class="navbar navbar-expand-lg justify-content-end">
                                ...
                                <div class="collapse navbar-collapse" id="footerNavContent">
                                    <ul class="navbar-nav ml-auto">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="product-details.html">Prodotti</a>
                                        </li>
                                        <li class="nav-item">
