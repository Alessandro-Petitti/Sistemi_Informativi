            ...
            <div class="widget catagory mb-30">
                ...
                <div class="catagories-menu">
                    <ul>
                        ...
                        <li><a href="shopsedie.php">Sedie</a></li>
                        <li><a href="shopdivani.php">Divani</a></li>
                        <li><a href="shopvasi.php">Vasi</a></li>
                        <li><a href="shoporologi.php">Orologi</a></li>
                        <li><a href="shoplampade.php">Lampade</a></li>
                    </ul>
                </div>
            </div>
